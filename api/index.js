...
// INICIALIZAÇÃO EXPLÍCITA PARA A VERCEL
const app = express();
...
// Configurações do Supabase/Asaas (Puxando das variáveis de ambiente da Vercel)
...
// Rota para garantir que o Frontend carregue na raiz
app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'index.html'));
});

// EXPORTAÇÃO QUE A VERCEL PRECISA
module.exports = app;